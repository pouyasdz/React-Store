...
function BottomNavigationBar() {
  ...
  return (
    <Box display={"flex"} width={"100%"} padding="10px" sx={downSmNoneStyle} alignItems="center">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <item.icon style={{fontSize:item.primary ? "1.5em":"1.2em", color:item.primary ? "black":"#5a5c7a"}}/>
                </Box>
              </Link>
            </Box>
            {item.primary && 
            <Divider flexItem orientation="vertical" variant="middle"  sx={{backgroundColor:"white", marginRight:"5px", marginLeft:"5px", opacity:"60%"}}/>
            }
        </>
          );
        })}
